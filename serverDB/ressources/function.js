...
module.exports.saveUser = async function (req, res) {
  let exist = false;
  PeopleSchema.find({ ssn: req.body.username }, function (err, docs) {
    if (docs != null) {
      if (docs.length) {
        exist = true;
      }
...
module.exports.updateUser = async function (req, res) {
  ...
  PeopleSchema.findOneAndUpdate(
    { username: new Number(req.body._username) },
    newData
  )
    .exec()
    .then((result) => {
...
module.exports.deleteUserByUsername = async function (req, res) {
  UserSchema.deleteOne({ username: req.params._username })
    .exec()
    .then((result) => {
      res.status(200).json({
...
module.exports.getByUsername = async function (req, res) {
  UserSchema.findOne({ username: req.params._username }, (e, result) => {
    if (e) {
...
module.exports.updatePeople = async function (req, res) {
  ...
  PeopleSchema.findOneAndUpdate({ ssn: new Number(req.body.ssn) }, newData)
    .exec()
    .then((result) => {
      res.status(200).json({
