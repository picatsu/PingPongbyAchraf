...
app.post("/api/v1/saveuser/", myRessource.saveUser);
app.get("/api/v1/allusers/", myRessource.getAllUsers);
app.put("/api/v1/userbyusername/:_username", myRessource.updateUser);
app.delete(
  "/api/v1/userbyusername/:_username",
  myRessource.deleteUserByUsername
);
app.get("/api/v1/userbyusername/:_username", myRessource.getByUsername);
