...
import { PongGame } from "./models2/classes/pong-game";
import { ControlState } from "./models2/classes/control-state";
import { Boundaries } from "./models2/classes/boundaries";
import { Controls } from "./models2/enums/controls";
...
export class VsdeuxComponent implements OnInit {
  ...
  constructor(
    ...
    this.controlEnnemiState = { upPressed: true, downPressed: false };
  }
