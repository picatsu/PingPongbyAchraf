$(function () {
  ...
  function drawBorder() {
    ...
    ctx.fillRect(
      0,
      GAME_SETTINGS.HEIGHT - GAME_SETTINGS.BORDER_WIDTH,
      GAME_SETTINGS.WIDTH,
      GAME_SETTINGS.BORDER_WIDTH
    );
  }
...
ButtonObject.prototype.initialize = function (
  canvas,
  ctx,
  GAME_SETTINGS,
  data
